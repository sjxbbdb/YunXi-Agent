# YunXi Agent v2.1.5-hotfix.1

YunXi Agent v2.1.5-hotfix.1 is a terminal-first Rust general companion Agent CLI and reusable core library.
...
The `v2.1.5-hotfix.1` release keeps the v2.1.4/hotfix Weixin state store, atomic local
...
- `crates/yunxi-agent-storage`: YunXi-owned session, control-audit, companion-history, and v2.1.5-hotfix.1 Weixin state storage boundary
...
Build and install the v2.1.5-hotfix.1 CLI into a user-local bin directory:
