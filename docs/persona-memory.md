...
YunXi Agent v2.0.4-hotfix.1 keeps persona and long-term memory local, inspectable, and
...
v2.0.4-hotfix.1 compiles the built-in persona into one bounded, XML-like context string
with stable block ordering:

```text
<yunxi_persona_context version="2.0.4-hotfix.1" profile_id="yunxi_companion_strong" mode="routed_memory">
<persona>...</persona>
