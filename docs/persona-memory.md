...
YunXi Agent v2.0.3 keeps persona and long-term memory local, inspectable, and
...
v2.0.3 compiles the built-in persona into one bounded, XML-like context string
with stable block ordering:

```text
<yunxi_persona_context version="2.0.3" profile_id="yunxi_companion_strong" mode="routed_memory">
<persona>...</persona>
